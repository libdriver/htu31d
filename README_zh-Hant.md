...
/src目錄包含了LibDriver HTU31D的源文件。

/interface目錄包含了LibDriver HTU31D與平台無關的IIC總線模板。

/test目錄包含了LibDriver HTU31D驅動測試程序，該程序可以簡單的測試芯片必要功能。

/example目錄包含了LibDriver HTU31D編程範例。

/doc目錄包含了LibDriver HTU31D離線文檔。

/datasheet目錄包含了HTU31D數據手冊。
...
在線文檔: [https://www.libdriver.com/docs/htu31d/index.html](https://www.libdriver.com/docs/htu31d/index.html)。
